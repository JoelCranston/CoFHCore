...
public class ChestBoatCoFH extends ChestBoat implements IOnPlaced {
    ...
    public ChestBoatCoFH(EntityType<? extends ChestBoat> type, Level worldIn, Supplier<Item> dropItem) {

        super(type, worldIn, dropItem);
    }

    public ChestBoatCoFH(Supplier<EntityType<? extends ChestBoat>> type, Level worldIn, Supplier<Item> dropItem, double posX, double posY, double posZ) {
