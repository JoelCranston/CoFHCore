...
public class CoreIngredientTypes {
    ...
    public static final DeferredHolder<IngredientType<?>, IngredientType<EmptyIngredient>> EMPTY = INGREDIENT_TYPES.register("empty", () -> new IngredientType<>(EmptyIngredient.CODEC, EmptyIngredient.STREAM_CODEC));
