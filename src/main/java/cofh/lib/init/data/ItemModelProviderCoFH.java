...
public abstract class ItemModelProviderCoFH extends ItemModelProvider {
    ...
    protected void fullToolSet(DeferredRegisterCoFH<Item> reg, String prefix) {

        standardToolSet(reg, prefix);
        extraToolSet(reg, prefix);
    }
    ...
    protected void extraToolSet(DeferredRegisterCoFH<Item> reg, String prefix) {
